...
def n_unet( n_classes ,  input_height=416, input_width=608 , encoder_level=3):

	model =  _unet( n_classes , get_encoder ,  input_height=input_height, input_width=input_width  )
	model.model_name = "n_unet"
	return model
